...
//获取 html 多模块入口文件
// var file_components = getEntry('./src/components/**/*.js', './src/');
...
var resolve = {
    ...
    alias: {
        ...
        // avalon2: path.join(PATHS.libsPath, "avalon/avalon.modern.js"),
        avalon2: path.join(PATHS.libsPath, "avalon/avalon.js"),
        mmRouter: path.join(PATHS.libsPath, "avalon/mmRouter.js"),
        lodash: path.join(PATHS.libsPath, "lodash.min.js"),

        /*
         * components
         */
        grid: path.join(PATHS.srcPath, "components/grid/grid.js"),
        pager: path.join(PATHS.srcPath, "components/pager/pager.js"),
...
pages.forEach(function(pathname) {
    var conf = {
        ...
        template: __dirname + '/src/'+pathname+'.html',
        /*
         * inject: true | 'head' | 'body' | false Inject all assets into the given template or templateContent -
         * When passing true or 'body' all javascript resources will be placed at the bottom of the body element.
         * 'head' will place the scripts in the head element.
        ...
        // 需要依赖的模块
        chunks: ['common', pathname, 'webpackAssets'],
